  ...
  if (item.type === "negative") {
    return (
      <div className="w-full h-1.5 bg-surface-variant rounded-full overflow-hidden flex justify-end">
        <div className="h-full bg-error rounded-full" style={{ width: `${width}%` }} />
      </div>
    );
  }
  if (item.type === "neutral") {
    return (
      <div className="w-full h-1.5 bg-surface-variant rounded-full overflow-hidden flex">
        <div className="h-full bg-outline-variant rounded-full" style={{ width: "56%" }} />
      </div>
    );
  }
  return (
    ...
    <div>
      <div className="flex justify-between items-end mb-6">
        ...
        <div className="flex gap-2">
          <button className="px-3 py-1.5 bg-surface-container border border-outline-variant text-on-surface text-label-uppercase rounded hover:bg-surface-variant transition-colors flex items-center gap-2">
            <MaterialIcon name="tune" size={16} />
            Model Params
          </button>
          <button className="px-3 py-1.5 bg-primary/10 border border-primary/30 text-primary text-label-uppercase rounded hover:bg-primary/20 transition-colors flex items-center gap-2">
      ...
      <div className="grid grid-cols-12 gap-gutter">
        {/* Model Confidence */}
        <div className="col-span-12 lg:col-span-3 bg-surface-container rounded-lg border-t-2 border-t-secondary border-x border-b border-outline-variant p-4 flex flex-col justify-between">
          ...
          <div className="w-full h-1 bg-surface-variant rounded-full mt-4 overflow-hidden">
            <div className="h-full bg-secondary w-[94.2%] rounded-full" />
          </div>
        </div>

        {/* Neural Network Focus */}
        <div className="col-span-12 lg:col-span-5 bg-surface-container rounded-lg border border-outline-variant p-0 relative overflow-hidden flex flex-col min-h-[200px]">
        ...
        <div className="col-span-12 lg:col-span-4 bg-surface-container rounded-lg border border-outline-variant p-4 flex flex-col">
        ...
        <div className="col-span-12 lg:col-span-8 bg-surface-container rounded-lg border-t-2 border-t-primary border-x border-b border-outline-variant flex flex-col h-[320px]">
        ...
        <div className="col-span-12 lg:col-span-4 bg-[#0a0f18] rounded-lg border border-outline-variant p-4 flex flex-col h-[320px] shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]">
