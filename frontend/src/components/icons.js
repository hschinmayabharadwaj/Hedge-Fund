export function LogoIcon({ className = "w-8 h-8" }) {
  return (
    <div className={`${className} bg-[#00ba88] rounded-md flex items-center justify-center flex-shrink-0`}>
...
export function PortfolioIcon({ className = "w-4 h-4" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function BankIcon({ className = "w-4 h-4" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6M4.5 10.5V21h15V10.5" />
    </svg>
  );
}
